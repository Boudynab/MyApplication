...
import 'package:flutter/material.dart' show AppBar, BorderRadius, BorderSide, BuildContext, Colors, Column, CrossAxisAlignment, EdgeInsets, ElevatedButton, Expanded, FloatingActionButton, FocusNode, FocusScope, FontWeight, Form, FormState, GlobalKey, InputDecoration, MainAxisAlignment, OutlineInputBorder, Padding, Row, Scaffold, SizedBox, State, StatefulWidget, Text, TextEditingController, TextFormField, TextInputType, TextStyle, Widget;
import 'package:flutter_application_2/genral%20file/results.dart';
